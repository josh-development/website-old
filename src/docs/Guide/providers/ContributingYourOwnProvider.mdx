...
To be able to contribute your own provider for this project you are required to have extensive knowledge with [TypeScript](https://www.typescriptlang.org). In order to get your workspace ready you will need to follow the steps in [`CONTRIBUTING.md`](https://github.com/josh-development/providers/blob/main/.github/CONTRIBUTING.md).
...
We have created a script to create your provider workspace, so you don't have too much trouble getting started.
